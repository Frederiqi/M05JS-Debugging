...
for (let person of array) {
    ...
    /* schrijf steeds een begeleidende tekst, zoals console.log("Dit is de gehele persoon:", [hier moet het object komen]); */
    console.log("dit is de naam van deze persoon: " + person.name);
